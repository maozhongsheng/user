package com.mk.ad.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    ACCOUNT_ERROR(4,"该账号不存在"),
    ACCOUNT_ERROR_SYSTEM(5,"该系统不支持此账号"),
    ACCOUNT_ERROR_SSP(4000003,"该账号审核未通过"),
    ACCOUNT_LOCK(4010001,"该账号被锁定,请联系系统管理员"),
    ACCOUNT_PASSWORD_ERROR(3,"用户名密码不匹配"),
